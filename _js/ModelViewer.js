...
function ModelViewer(container) {
    ...
    this.element.setAttribute('class', 'block-viewer')
    ...
    this.getAll = function () {
        ...
        return Object.keys(self.models).map(function (name) {
            return self.models[name]
        })
 ...
 *  JsonModel
 *****************************/
function JsonModel(name, rawModel, clipUVs) {

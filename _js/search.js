    ...
    4: [function (require, module, exports) {
        ...
        function FuzzySearchStrategy() {
            function makeFuzzy(string) {
                return string = string.split("").join(".*?"), string = string.replace("??", "?"), new RegExp(string, "gi")
            }

            this.matches = function (string, crit) {
                return "string" != typeof string || "string" != typeof crit ? !1 : (string = string.trim(), !!makeFuzzy(crit).test(string))
            }
        }
    ...
    7: [function (require, module, exports) {
        !function (window, document, undefined) {
            ...
            function isWhitelistedKey(key) {
                return -1 === [13, 16, 20, 37, 38, 39, 40, 91].indexOf(key)
            }
